...
namespace ParsersAttributes {
    ...
    ANALYZE_COUNT=QString("analyze-count"),
    ...
    AUTOVACUUM_COUNT=QString("autovacuum-count"),
    AUTOANALYZE_COUNT=QString("autoanalyze-count"),
    ...
    INDEX_SCAN=QString("index-scan"),
    INDEX_SCAN_READ=QString("index-scan-read"),
	INFO=QString("info"),
    ...
    SEQ_SCAN=QString("seq-scan"),
    SEQ_SCAN_READ=QString("seq-scan-read"),
    ...
    VACUUM_COUNT=QString("vacuum-count"),
